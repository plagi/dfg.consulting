...
(function(){
  ...
  var w=new DFGWorld.World(c,{nx:100,nz:60,bg:'#11141A',pitch:0.5,camY:0.9,cy:0.46,cyMobile:0.46,fRatio:2.1,mobileF:1.15,seed:2026,relief:0.4});
  ...
  function set(i,byUser){
    ...
    w.setScript(DFGWorld.stageScript(i)); w.play();
