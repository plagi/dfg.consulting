...
| AI pilot review | Whether and how to fund further work | Evidence-linked findings, continuation options and remaining dependencies | DFG reviews the scoped pilot; production implementation belongs to internal teams/providers |
